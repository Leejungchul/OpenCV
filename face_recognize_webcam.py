...
bill_image = face_recognition.load_image_file("img/bill.jpg")
bill_face_encoding = face_recognition.face_encodings(bill_image)[0]
steve_image = face_recognition.load_image_file("img/messi.jpg")
steve_face_encoding = face_recognition.face_encodings(steve_image)[0]
jhkim_image = face_recognition.load_image_file("img/ronaldo.jpg")
